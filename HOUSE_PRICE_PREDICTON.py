...
train = pd.read_csv("House_Price/data/train.csv")
test = pd.read_csv("House_Price/data/test.csv")
...
# Log'u düzeltmek için tekrar tanımlayalım
...
pred_data = X.sample(1, random_state=42)
lgbm.predict(pred_data)

# Tüm datayı tahminleme
y_pred = lgbm.predict(X)
y_test = y.copy()  # gerçek değerler

from sklearn.metrics import accuracy_score, precision_score, recall_score, f1_score
accuracy = accuracy_score(y_test, y_pred)
precision = precision_score(y_test, y_pred, pos_label="species", average=None)
recall = recall_score(y_test, y_pred, pos_label="species", average="weighted")
f1 = f1_score(y_test, y_pred, pos_label="species", average="weighted")
